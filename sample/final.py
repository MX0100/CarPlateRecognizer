...
# Specify the path to Tesseract executable (Windows users need to specify the path)
pytesseract.pytesseract.tesseract_cmd = r'C:\Program Files\Tesseract-OCR\tesseract.exe'


def process_image(image_path):
    # Step 1: Image Acquisition
    image = cv2.imread('c0.jpg')
    if image is None:
...
# Example usage
image_path = r'C:/Users/WenKai/Desktop/License-Plate-Recognition-master/c0.jpg'
